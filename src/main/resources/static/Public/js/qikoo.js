...
qikoo.dialog = function() {
    ...
    var r = ['<div class="dialog-content">', "<p>" + e + "</p>", "</div>", '<div class="dialog-console clearfix_new">', '<a class="console-btn-confirm" href="javascript:void(0)" onclick="return false;">确定</a>', '<a class="console-btn-cancel" href="javascript:void(0)" onclick="return false;">取消</a>', "</div>"].join(""),
        i = qikoo.dialog.show({
            html: r
        });
    ...
    var n = ['<div class="dialog-content">', "<p>" + e + "</p>", "</div>", '<div class="dialog-console clearfix_new">', '<a class="console-btn-confirm" href="javascript:void(0)" onclick="return false;">确定</a>', "</div>"].join(""),
        r = qikoo.dialog.show({
            html: n
        });
    ...
    var r = qikoo.dialog.show({
        html: ['<div class="dialog-content" style="padding: 0 80px; text-align:left">', '<div class="content-title">请您在新打开的页面<br>上完成付款。</div>', '<p style="padding-left: 50px">付款完成前请不要关闭此窗口。<br>完成付款后请根据您的情况点击下面的按钮：</p>', "</div>", '<div class="dialog-console clearfix_new" style="margin:25px auto;width:252px;">', '<a class="console-btn-confirm" href="javascript:void(0)" onclick="return false;">已完成付款</a>', '<a class="console-btn-cancel" href="javascript:void(0)" onclick="return false;">付款遇到问题</a>', "</div>"].join(""),
        width: 530,
        closeFn: n
    });
    ...
    var t, n = ['<div class="mod-pop">', '<div class="pop-nav">', '<span class="pop-title"></span>', '<a class="pop-close" href="javascript:void(0)" onclick="return false"></a>', "</div>", '<div class="pop-main"></div>', "</div>"].join("");
    ...
    var e, t = function(e) {
            var t = ["<p>" + e + "</p>", '<div class="pop-console">', '<a class="pop-btn-green" href="javascript:void(0)" onclick="return false">确定</a>', '<a class="pop-btn-gray" href="#" onclick="return false">取消</a>', "</div>"].join("");
            return qikoo.pop({
                title: "温馨提示：",
                html: t
            })
