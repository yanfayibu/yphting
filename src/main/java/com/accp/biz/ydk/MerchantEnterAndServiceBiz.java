...
import com.accp.dao.ydk.MerchantEnterAndServiceDao;
...
public class MerchantEnterAndServiceBiz {
	 ...
	 * 查询人工智能根据userid
	 */
	public List<Rgzn> queryRgznByUserid(Integer userid, Integer stid) {
		return dao.queryRgznByUserid(userid, stid);
	}

	/**
	 * 用查到的人工智能数据中的stid来查询相似商品
	 */
	public PageInfo queryXiangSiServices(Integer num, Integer size, Integer oftenid) {
		PageHelper.startPage(num, size);
		return new PageInfo(dao.queryXiangSiServices(oftenid));
	}
	//人工分析 查询
